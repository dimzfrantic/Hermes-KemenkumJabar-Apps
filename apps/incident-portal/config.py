...
INCIDENT_ENGINE_DIR = BASE_DIR / 'incident_engine'
...
class Config:
    ...
    INCIDENTS_DIR = os.getenv('INCIDENTS_DIR', str(INCIDENT_ENGINE_DIR))
    INCIDENT_WRITER_PATH = os.getenv('INCIDENT_WRITER_PATH', str(INCIDENT_ENGINE_DIR / 'incident_writer.py'))
    ...
    ADMIN_NAME = os.getenv('ADMIN_NAME', 'Admin Portal')
